...
{#if saveLayoutState.isOpen}
  ...
  <!--
    Accessibility: The backdrop is a presentational element that provides:
    1. Visual dimming of the background
    2. Click-to-dismiss functionality
    Keyboard interaction is handled on the dialog surface (role="dialog") which
    captures focus and handles Escape key. The backdrop intentionally does not
    have keyboard interaction as it's not focusable content.
  -->
